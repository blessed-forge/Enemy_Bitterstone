...
--		ButtonSetText ("EnemyIntercomDialogCreateButton", L"Create")
				...
				LabelSetText ("EnemyIntercomDialogCreateText4", L"Join Scenario Party Intercomm channel?")
		ButtonSetText ("EnemyIntercomDialogCreateButton4", L"Scenario Party")
	
			LabelSetText ("EnemyIntercomDialogCreateText3", L"Join Scenario Intercomm channel?")
		ButtonSetText ("EnemyIntercomDialogCreateButton3", L"Scenario")
	

		LabelSetText ("EnemyIntercomDialogCreateText2", L"Join Warband Intercomm channel?")
		ButtonSetText ("EnemyIntercomDialogCreateButton2", L"Warband")
	
		LabelSetText ("EnemyIntercomDialogCreateText", L"Join Party Intercomm channel?")
		ButtonSetText ("EnemyIntercomDialogCreateButton", L"Party")
