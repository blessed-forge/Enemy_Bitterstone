...
<ModuleFile xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<UiMod name="Enemy" version="2.8.0" date="01/07/2012" autoenabled="true">
	
		<VersionSettings gameVersion="1.4.7" windowsVersion="1.0" savedVariablesVersion="1.0" />
		
		<Author name="LM" email="logutov@gmail.com" />
		<Description text="A set of tools for a premade group play." />
